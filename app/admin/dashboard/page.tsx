      ...
      <div className="mx-auto max-w-6xl space-y-12">
        ...
        <RsvpTable
          initialParties={parties.map((p) => ({
            ...
            email: p.email,
            phone: p.phone,
            attendingSunday: p.attendingSunday,
            attendingMonday: p.attendingMonday,
            hotel: p.hotel,
            shuttleToHacienda: p.shuttleToHacienda,
            shuttleBack: p.shuttleBack,
            shuttleBackTime: p.shuttleBackTime,
            starterChoice: p.starterChoice,
