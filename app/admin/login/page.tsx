  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-cream-100 px-6">
      ...
      >
        ...
        <div>
          <label htmlFor="password" className="mb-1 block font-body text-xs uppercase tracking-wide text-clay-700/70">
            Password
          </label>
          <input
            id="password"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded-full bg-clay-700 px-8 py-3 font-body text-sm uppercase tracking-[0.2em] text-cream-50 transition-colors duration-200 ease-in-out hover:bg-clay-800 disabled:opacity-60"
        >
